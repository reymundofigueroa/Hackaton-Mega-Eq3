...
BEGIN TRY
    ...
    INSERT INTO Domicilios (calle, numero_exterior, id_colonia) VALUES 
      ('Av. Patria','1234',@id_col1), ('Blvd. Díaz Ordaz','4321',@id_col2), ('Calle Falsa','321',@id_col3), ('Av. Miguel Ángel de Quevedo','150',@id_col3), ('Blvd. de la Campana','500',@id_col4), ('Calle 20','311',@id_col5),
      -- (6 Domicilios Adicionales)
      ('Paseo de la Reforma', '222', @id_col3), ('Av. Lázaro Cárdenas', '2305', @id_col2), ('Calle Hidalgo', '56', @id_col1), ('Circuito Juriquilla', '1030', @id_col4), ('Calle 60', '455', @id_col5), ('Av. de los Insurgentes', '2021', @id_col3);
    ...
    INSERT INTO Suscriptores (nombre,apellido_paterno,rfc,email,telefono_contacto,id_domicilio) VALUES 
      ('Luis','Pérez','PEGL850101ABC','luis.perez@mail.com','33-1111-2222',@id_domic1), ('María','López','LOML900202DEF','maria.lopez@mail.com','81-3333-4444',@id_domic2), ('Carlos','Ramírez','CARR950303GHI','carlos.ramirez@mail.com','55-5555-6666',@id_domic3), ('Sofía','Herrera','SOHO970404JKL','sofia.herrera@mail.com','55-7777-8888',@id_domic4), ('Ana','García','GAAA920505MNO','ana.garcia@mail.com','44-2999-8888',@id_domic5), ('David','Martínez','MADM880606PQR','david.martinez@mail.com','99-9111-2222',@id_domic6),
      -- (6 Suscriptores Adicionales)
      ('Laura','Sánchez','SALL910707STU','laura.sanchez@mail.com','55-1212-3434',@id_domic7), ('Jorge','Gómez','GOFJ890808VWX','jorge.gomez@mail.com','81-3434-5656',@id_domic8), ('Patricia','Flores','FLOP930909YZA','patricia.flores@mail.com','33-5656-7878',@id_domic9), ('Miguel','Rojas','ROMM941010BCD','miguel.rojas@mail.com','44-2323-4545',@id_domic10), ('Verónica','Cruz','CRUV961111EFG','veronica.cruz@mail.com','99-9595-6767',@id_domic11), ('Ricardo','Mora','MORR871212HIJ','ricardo.mora@mail.com','55-6767-8989',@id_domic12);
    ...
    -- 9. Aplicación de promociones a contratos
    ...
    INSERT INTO Movimientos_Cuenta (id_contrato,concepto,monto_cargo,monto_pago,saldo_resultante) VALUES
        ...
        -- Historial Contrato 2 (María, TV $300, Promo Desc. Instalación)
        (@id_contrato2, 'Cargo por Instalación',  800.00, 0.00,   800.00), 
        (@id_contrato2, 'Abono por Promo Instalación', 0.00, 200.00, 600.00),
        (@id_contrato2, 'Pago de Instalación',      0.00, 600.00,     0.00),
        ...
        -- Historial Contrato 4 (Sofía, Internet $650, Promo Geo 15% -> $552.50/mes)
